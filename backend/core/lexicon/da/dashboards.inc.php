...
$_lang['dashboard_widgets.intro_msg'] = 'Her kan du tilføje, indstille og fjerne Widgets fra dette betjeningspanel. Du kan også trække og slippe rækkerne i tabellen for at omarrangere dem.';
...
$_lang['widget_size_desc'] = 'Størrelsen på widget. Enten kan den være en halv skærm ("halv"), den fulde vinduesbredde ("fuld") eller en den fulde vinduesbredde og med to rækker ("dobbelt").';
$_lang['widget_size_double'] = 'Dobbelt';
$_lang['widget_size_full'] = 'Fuld';
