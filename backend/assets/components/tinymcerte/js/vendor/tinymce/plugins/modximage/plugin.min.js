...
tinymce.PluginManager.add('modximage', function(editor) {
	...
	function showDialog(imageList) {
		...
		if (editor.settings.image_advtab) {
			...
			if (imgElm) {
				...
				if (imgElm.style.float) {
					data.position = imgElm.style.float;
				}
...

					{
						...
						items: [
							...
							,{
								...
								name: 'position',
								type: 'listbox',
								onselect: updateStyle, // pick up new value
								values: [
									{text: 'None', value: ''}
